...
/**
 * Http Streams based implementation of CF7GSC_IO.
 *
...
class CF7GSC_IO_Stream extends CF7GSC_IO_Abstract
{
  ...
  public function executeRequest(CF7GSC_Http_Request $request)
  {
    ...
    if ($this->trappedErrorNumber) {
      ...
      throw new CF7GSC_IO_Exception($error, $this->trappedErrorNumber);
    }
    ...
    if (false === $response_data) {
      ...
      $this->client->getLogger()->error('Stream ' . $error);
      throw new CF7GSC_IO_Exception($error, $respHttpCode);
    }
