 ...
 */
class CF7GSC_Cache_Memcache extends CF7GSC_Cache_Abstract
{
  ...
  public function __construct(CF7GSC_Client $client)
  {
    if (!function_exists('memcache_connect') && !class_exists("Memcached")) {
      ...
      throw new CF7GSC_Cache_Exception($error);
    }
  ...
  public function set($key, $value)
  {
    ...
    if ($rc == false) {
      ...
      throw new CF7GSC_Cache_Exception("Couldn't store data in cache");
    }
