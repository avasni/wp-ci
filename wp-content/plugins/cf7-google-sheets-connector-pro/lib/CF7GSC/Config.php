...
class CF7GSC_Config
{
  ...
  /**
   * Create a new CF7GSC_Config. Can accept an ini file location with the
  ...
  public function __construct($ini_file_location = null)
  {
    $this->configuration = array(
      ...
      'auth_class'    => 'CF7GSC_Auth_OAuth2',
      'io_class'      => self::USE_AUTO_IO_SELECTION,
      'cache_class'   => 'CF7GSC_Cache_File',
      'logger_class'  => 'CF7GSC_Logger_Null',
      ...
      'classes' => array(
        'CF7GSC_IO_Abstract' => array(
          'request_timeout_seconds' => 100,
        ),
        'CF7GSC_IO_Curl' => array(
          'disable_proxy_workaround' => false,
          'options' => null,
        ),
        'CF7GSC_Logger_Abstract' => array(
          'level' => 'debug',
          'log_format' => "[%datetime%] %level%: %message% %context%\n",
          'date_format' => 'd/M/Y:H:i:s O',
          'allow_newlines' => true
        ),
        'CF7GSC_Logger_File' => array(
          'file' => 'php://stdout',
          'mode' => 0640,
          'lock' => false,
        ),
        'CF7GSC_Http_Request' => array(
        ...
        'CF7GSC_Service_Exception' => array(
          'retry_map' => array(
        ...
        'CF7GSC_Cache_File' => array(
          'directory' => sys_get_temp_dir() . '/CF7GSC_Client'
        )
      ),
    );
   ...
   * the hd values within an id token (@see CF7GSC_Auth_LoginTicket) after sign
