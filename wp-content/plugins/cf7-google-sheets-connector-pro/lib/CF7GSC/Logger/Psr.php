 ...
 * with the `CF7GSC_Logger_Psr::setLogger()` method.
 */
class CF7GSC_Logger_Psr extends CF7GSC_Logger_Abstract
{
  /**
   ...
   */
  public function __construct(CF7GSC_Client $client, /*Psr\Log\LoggerInterface*/ $logger = null)
  {
