 ...
 */
$consts = array(
  'INSTAPAGE_ENTERPRISE_ENDPOINT' => 'https://secure.pageserve.co',
  'INSTAPAGE_PROXY_ENDPOINT' => 'https://app.instapage.com',
  'INSTAPAGE_APP_ENDPOINT' => 'https://app.instapage.com/api/plugin'
);
