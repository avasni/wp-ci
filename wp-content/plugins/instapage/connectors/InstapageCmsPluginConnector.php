...
class InstapageCmsPluginConnector {
  ...
  public static function getPluginRequirements($features) {
    ...
    $commonFeatures = array(
      ...
      array('label' => InstapageCmsPluginConnector::lang('Every request for landing page requires a request to our page server (https://secure.pageserve.co) and this URL has to be accessible.'), 'condition' => InstapageCmsPluginConnector::isAPIAccessible())
    );
